...
export async function seedFirestore() {
  ...
  // ====== FLEET TYPES ======
  const fleetTypes = [
    { id: 'closed-van', name: 'Closed Van', capacity: '2,000kg - 4,000kg', icon: 'Closed Van', description: '6-Wheeler Closed Van ideal for general cargo and dry goods', pricePerKm: 85 },
    { id: 'flatbed-truck', name: 'Flatbed Truck', capacity: '10,000kg+', icon: 'Flatbed Truck', description: 'Heavy-duty flatbed for construction materials and oversized cargo', pricePerKm: 120 },
    { id: 'refrigerated', name: 'Refrigerated', capacity: '3,000kg - 5,000kg', icon: 'Refrigerated', description: 'Temperature-controlled transport for perishable goods', pricePerKm: 150 },
    { id: 'prime-mover', name: 'Prime Mover', capacity: '20,000kg+', icon: 'Prime Mover', description: 'Heavy-duty tractor head for container hauling and port operations', pricePerKm: 200 },
  ];
  ...
  // ====== NOTIFICATIONS ======
  const notifs = [
    { id: 'notif-001', type: 'booking', title: 'Booking Confirmed', message: 'Your transport request from SBMA Port Terminal 3 to Olongapo Industrial Park has been approved. A driver will be assigned shortly.', location: 'SBMA Wharf Terminal 3', time: '10 mins ago', isNew: true, actions: ['View Details', 'Mark as Read'], userId: 'user-001' },
    { id: 'notif-002', type: 'appointment', title: 'Viewing Scheduled', message: 'Your appointment to inspect the 2022 Isuzu Giga is confirmed at our Olongapo Main Hub. Please bring your valid ID.', location: 'GCLT Olongapo Main Hub', time: '2 hours ago', isNew: true, actions: ['View Details', 'Mark as Read'], userId: 'user-001' },
    { id: 'notif-003', type: 'payment', title: 'Payment Received', message: 'Receipt #GCLT-8829 for the SBMA-Olongapo freight service has been generated and sent to your email.', time: '5 hours ago', isNew: false, actions: ['View Details'], userId: 'user-001' },
    { id: 'notif-004', type: 'system', title: 'Route Delay Alert', message: 'Severe traffic congestion reported near the Olongapo City entrance. Expect a 30-minute delay for all incoming SBMA deliveries.', location: 'Olongapo Gateway', time: 'Yesterday', isNew: false, actions: ['View Details'], userId: 'user-001' },
    { id: 'notif-005', type: 'system', title: 'Profile Updated', message: 'Your business address has been successfully updated to 122 Rizal Ave, Olongapo City.', time: '2 days ago', isNew: false, actions: ['View Details'], userId: 'user-001' },
    { id: 'notif-006', type: 'booking', title: 'Service Completed', message: 'The delivery from SBMA Free Trade Zone to Olongapo Distribution Center was successfully completed by driver Juan Dela Cruz.', location: 'SBMA Free Trade Zone', time: '3 days ago', isNew: false, actions: ['View Details'], userId: 'user-001' },
  ];
